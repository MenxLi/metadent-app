...
function toggleLowConfidence() {
  ...
  model.value.autoGenerated = false
}
...
function clearContours() {
  if (model.value.autoGenerated) {
    // If contours were auto-generated,
    // also reset the description and autoGenerated flag
    model.value.autoGenerated = null
    model.value.description = ''
  }
...
<template>
  ...
  >
    ...
    <input
      ...
      @input="model.autoGenerated = false; handleInput($event)"
