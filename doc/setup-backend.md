...
::: details File and Directory Naming Conventions
...
:::details Upload the Files via Command Line (Alternative to Web Panel)

You can use the [LFSS CLI tool](https://menxli.github.io/lfss/client-intro.html#python-tools) to upload your project directory to the server:
...
::: details Auxillary AI Service (Optional)
